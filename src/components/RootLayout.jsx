...
import logoWithWords from "@/images/logo_with_words.png";
...
const NavigationItem = ({ href, children }) => {
  return (
    ...
    >
      {children}
      <span className="absolute inset-y-0 -z-10 w-screen bg-accent/20 opacity-0 transition group-odd:right-0 group-even:left-0 group-hover:opacity-100" />
    </Link>
  );
};
...
const Navigation = () => {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-primary-foreground/95">
      <NavigationRow>
